...
while True:
    ...
    class Emu:
    #Emu
        pygame.draw.rect(screen, Emu_colour, (x_E, y_E, width_Emu, hight_Emu))
        pygame.draw.rect(screen, Emu_colour, (x_E + 100, y_E, A_width_Emu, A_hight_Emu))
        pygame.draw.rect(screen, Emu_colour, (x_E + 200, y_E, B_width_Emu, B_hight_Emu))
        pygame.draw.rect(screen, Emu_colour, (x_E - 100, y_E, C_width_Emu, C_hight_Emu))
        pygame.draw.rect(screen, Emu_colour, (x_E - 200, y_E, D_width_Emu, D_hight_Emu))
        #speed Emu go down
    ...
    """if L_y > y_E - (width_Emu/2) and L_y < y_E + (width_Emu/2) :"""
    if L_x > x_E and L_x < (x_E + width_Emu)and L_y > y_E and  L_y < (y_E + width_Emu):
        Emu_colour = red
        L_y = y
        shoot = 0
        Emu_HP = (Emu_HP - L_DMG)
